...
public class ColorUtils {
    ...
    public static int getDimensionDp(int resID, Context context) {
        // Simplificando la conversión de recursos a píxeles usando getResources().getDimensionPixelSize(), que incluye la densidad de pantalla
        return context.getResources().getDimensionPixelSize(resID);
    }

    public static int dip2px(float dpValue, Context context) {
        // Simplificando la conversión de dp a píxeles con getResources().getDisplayMetrics()
